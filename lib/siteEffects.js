...
export default function initSiteEffects() {
  ...
  function wireCursor() {
    ...
    sg.addColorStop(0.00, "rgba(255,240,244,1)");
    sg.addColorStop(0.20, "rgba(247,207,217,0.72)");
    sg.addColorStop(0.50, "rgba(214,126,152,0.26)");
    sg.addColorStop(1.00, "rgba(239, 162, 182,0)");
