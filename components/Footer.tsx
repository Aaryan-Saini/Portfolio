...
import WavesShaderBackground from "@/components/ui/WavesShaderBackground";
...
export default function Footer() {
  return (
    <footer className="footer" id="footer">
      ...
      {/* giant translucent wordmark — the sky bleeds through it */}
      ...
      <div className="footer__inner">
        <div className="footer__top">
          <h2 className="footer__cta">
            let&rsquo;s{" "}
            <em data-cycle="test,break,automate,validate,ship,refine,perfect">
              test
            </em>
            <br />
            incredible work
        ...
        <div className="footer__contact">
          <div>
            ...
            <a className="footer__mail" href="mailto:aaryankrsaini24@gmail.com" data-cursor="link">
